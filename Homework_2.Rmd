...
```{r}
model2 <- lmer(cbmom ~ (1 | FAMID), data = purpose_long)
summary(model2)
```
...
Fixed effect estimate for intercept decreased from 1.60 to 1.32, because we are accounting for some of the variance with our new fixed slope term.
